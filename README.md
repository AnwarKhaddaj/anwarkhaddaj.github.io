...
<body>         
    ...
    <div class="floating-block" style="background-color: #1E6FA8; color: #f5f5f5; padding: 10px 15px; border-radius: 10px; display: inline-block; margin: 15px;">
        <p style="margin: 0; font-size: 1rem;">Apr 15, 2023</p>
    </div>
    I have successfully defended my Master's thesis on <a href="https://events.rice.edu/event/364768-parameter-estimation-of-neuron-models-using-subset" target="_blank">"Parameter Estimation of Neuron Models using Subset Selection and Dynamic Optimization"</a> <br/><br/>
</span> 
